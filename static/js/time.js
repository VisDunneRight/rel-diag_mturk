...
function record_tutorial_time(page_offset) {
    ...
    data = { tutorial_page_num: tutorial_page_num, time_spent: delta_t, worker_id: worker_id, current_page: tutorial_page_num + page_offset };
    $.ajax({
        url: url,
        type: 'POST',
